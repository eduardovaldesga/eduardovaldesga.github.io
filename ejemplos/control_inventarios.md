...
Esta simulación emula el control de inventarios de un almacen. Aparece como ejemplo en el libro "Simulación un enfoque práctico" de Raul Coss Bu. (pág. 84). Suponga que la demanda de cierto producto obedece a la siguiente distribución de probabilidad empírica:
